    ...
    <>
      {dots ? (
        <div className="flex flex-col sm:flex-row items-center w-[90%] max-w-6xl align-middle  ">
          <div className="sm:border-b-2 sm:border-dotted sm:w-2/5"></div>
          <h2
            className="text-white text-2xl md:text-3xl text-center tracking-widest font-medium mt-5 mb-4 mx-3 sm:w-1/5
  "
          >
            {name}
          </h2>
