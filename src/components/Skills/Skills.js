...
const Skills = () => {
  ...
  return (
    <section id="skills" className="flex flex-col items-center  p-4 mt-2">
      <div className="flex flex-col mb-6 mt-10  p-1 w-[92%] items-center justify-center ">
        <SectionHead name="SKILLS" dots={false} />

        <div className="h-content w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-1  ">
          <div>
